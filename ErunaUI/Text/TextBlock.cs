...
//        private Vector2 VectorSize => new Vector2(TrueWidth, TrueHeight);
...
//            spriteBatch.DrawStringAligned(spriteFont, ParsedText ?? TextString, new Vector2(PosX, PosY), Color, TextAlign, TextGravity, VectorSize, 0);
//        }

//        public void ParseText()
//        {
//            if (TextString == PreviouslyParsedTextString && VectorSize == PreviouslyParsedSize)
//                return;
...
//            ParsedText = ParseText(TextString, TrueWidth, TrueHeight, out string trimmedText, out int trimmedIndex);

//            ParserTrimmedIndex = trimmedIndex;
//            ParserTrimmedText = trimmedText;

//            PreviouslyParsedSize = new Vector2(TrueWidth, TrueHeight);
